    ...
    >
      ...
      >
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
            ...
            <div>
              ...
              <p style={{ fontSize: '0.74rem', color: 'var(--text-muted)', margin: 0, marginTop: '2px' }}>
                {lang === 'fr'
                  ? 'Architecture, vision d\'ingénierie et catalogue des 27 chantiers majeurs créés par LordMadTrix'
                  : 'Architecture, engineering vision, and catalog of all 27 major milestones by LordMadTrix'}
              </p>
            </div>
          </div>
        ...
        <div style={{
          ...
          {[
            { icon: <CheckCircle2 size={16} color="#10b981" />, val: '639 Tests', label: 'Vitest 100% Verts' },
            { icon: <ShieldCheck size={16} color="#84cc16" />, val: '0 Warning', label: 'Oxlint sur 67 fichiers' },
            { icon: <Layers size={16} color="#38bdf8" />, val: '27 Chantiers', label: '100% Réels & Câblés' },
