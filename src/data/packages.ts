...
export const SOFTWARE_PACKAGES: SoftwarePackage[] = [
  ...
  {
    id: 'gnome_tweaks',
    name: 'GNOME Tweaks (Ajustements & Personnalisation GNOME)',
    category: 'system',
    description: 'Outil officiel pour personnaliser finement GNOME : gestion des thèmes GTK, curseurs, polices, extensions, boutons de fenêtres et comportements graphiques.',
    sizeMB: 30,
    icon: 'Sliders',
    tags: ['GNOME', 'Tweaks', 'Thèmes', 'Polices', 'Curseurs'],
    pkgNames: {
      debian: 'gnome-tweaks',
      ubuntu: 'gnome-tweaks',
      arch: 'gnome-tweaks',
  ...
  {
    id: 'dconf_editor',
    name: 'Dconf Editor (Éditeur Graphique de Registre GSettings)',
    category: 'system',
    description: 'Éditeur visuel avancé pour parcourir et modifier toutes les clés de configuration bas niveau dconf et gsettings de l’environnement de bureau.',
    sizeMB: 15,
    icon: 'Settings',
    tags: ['Dconf', 'GSettings', 'Registre', 'Tweaks', 'Configuration'],
    pkgNames: {
      debian: 'dconf-editor',
      ubuntu: 'dconf-editor',
      arch: 'dconf-editor',
  ...
  {
    id: 'lxappearance',
    name: 'LXAppearance (Sélecteur Universel de Thèmes GTK)',
    category: 'system',
    description: 'Gestionnaire graphique léger et universel pour sélectionner les thèmes GTK2/GTK3, jeux d’icônes, curseurs de souris et polices (idéal Tiling WMs et bureaux légers).',
    sizeMB: 10,
    icon: 'Palette',
    tags: ['GTK', 'Thèmes', 'Icônes', 'Curseurs', 'Tiling', 'Léger'],
    pkgNames: {
      debian: 'lxappearance',
      ubuntu: 'lxappearance',
      arch: 'lxappearance',
  ...
  {
    id: 'arandr',
    name: 'ARandR (Gestionnaire Visuel Multi-Écrans & Résolutions)',
    category: 'system',
    description: 'Interface graphique intuitive basée sur XRandR permettant de positionner, pivoter, activer et définir les résolutions et fréquences d’affichage multi-moniteurs.',
    sizeMB: 12,
    icon: 'Monitor',
    tags: ['Écrans', 'Affichage', 'XRandR', 'Multi-moniteur', 'Résolution'],
    pkgNames: {
      debian: 'arandr x11-xserver-utils',
      ubuntu: 'arandr x11-xserver-utils',
      arch: 'arandr xorg-xrandr',
      fedora: 'arandr xrandr',
      alpine: 'arandr xrandr',
      opensuse: 'arandr xrandr',
      void: 'arandr xrandr',
    },
    appType: 'gui',
    systemImpact: 'low',
  ...
  {
    id: 'pavucontrol',
    name: 'Pavucontrol (Mixeur Audio PulseAudio & PipeWire)',
    category: 'audio',
    description: 'Contrôleur de volume et mixeur audio graphique complet permettant de régler individuellement les volumes d’applications, entrées micros et sorties casques/enceintes.',
    sizeMB: 20,
    icon: 'Volume2',
    tags: ['Audio', 'Mixeur', 'PipeWire', 'PulseAudio', 'Volume', 'Micro'],
    pkgNames: {
      debian: 'pavucontrol',
      ubuntu: 'pavucontrol',
      arch: 'pavucontrol',
  ...
  {
    id: 'blueman',
    name: 'Blueman (Gestionnaire Bluetooth Graphique & Applet)',
    category: 'system',
    description: 'Gestionnaire Bluetooth complet en GTK avec applet dans la barre des tâches pour appairer, transférer des fichiers et connecter casques et périphériques sans fil.',
    sizeMB: 25,
    icon: 'Bluetooth',
    tags: ['Bluetooth', 'Sans-fil', 'Applet', 'Audio', 'Périphériques'],
    pkgNames: {
      debian: 'blueman bluez',
      ubuntu: 'blueman bluez',
      arch: 'blueman bluez',
      fedora: 'blueman bluez',
      alpine: 'blueman bluez',
      opensuse: 'blueman bluez',
      void: 'blueman bluez',
    },
    appType: 'gui',
    systemImpact: 'low',
