...
export const SOFTWARE_PACKAGES: SoftwarePackage[] = [
  ...
  {
    id: 'mpv_player',
    name: 'MPV (Lecteur Vidéo Minimaliste & Puissant)',
    category: 'multimedia',
    description: 'Lecteur multimédia ultra-léger basé sur mplayer2/FFmpeg avec accélération matérielle GPU et scripts Lua.',
    sizeMB: 45,
    icon: 'Play',
    tags: ['MPV', 'Vidéo', 'Lecteur', 'GPU', 'Minimaliste'],
    pkgNames: {
      debian: 'mpv',
      ubuntu: 'mpv',
      arch: 'mpv',
  ...
  {
    id: 'obs_studio',
    name: 'OBS Studio (Capture & Diffusion en Direct)',
    category: 'multimedia',
    description: 'Logiciel professionnel open source d’enregistrement d’écran et de streaming vidéo en direct.',
    sizeMB: 220,
    icon: 'Video',
    tags: ['OBS', 'Streaming', 'Capture', 'Vidéo', 'Twitch', 'YouTube'],
    pkgNames: {
      debian: 'obs-studio',
      ubuntu: 'obs-studio',
      arch: 'obs-studio',
