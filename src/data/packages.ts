...
export const SOFTWARE_PACKAGES: SoftwarePackage[] = [
  ...
  // --- SAUVETAGE, FORENSICS & DÉPANNAGE DISQUE ---
  {
    id: 'testdisk',
    name: 'TestDisk & PhotoRec (Récupération de Données)',
    category: 'system',
    description: 'Outils indispensables de récupération de partitions perdues et de fichiers supprimés (PhotoRec).',
    sizeMB: 35,
    icon: 'HardDrive',
    tags: ['Rescue', 'Forensics', 'Partition', 'PhotoRec'],
    pkgNames: {
      debian: 'testdisk',
      ubuntu: 'testdisk',
      arch: 'testdisk',
  ...
  {
    id: 'ddrescue',
    name: 'GNU ddrescue (Sauvetage de Disques Défaillants)',
    category: 'system',
    description: 'Outil de copie et de clonage sécurisé pour récupérer des données sur des supports avec secteurs défectueux.',
    sizeMB: 15,
    icon: 'HardDrive',
    tags: ['Rescue', 'Clone', 'BadSectors', 'HDD'],
    pkgNames: {
      debian: 'gddrescue',
      ubuntu: 'gddrescue',
      arch: 'ddrescue',
  ...
  {
    id: 'smartmontools',
    name: 'Smartmontools (Santé Disques SMART & NVMe)',
    category: 'system',
    description: 'Surveillance et tests de santé SMART pour disques durs HDD, SSD SATA et SSD NVMe.',
    sizeMB: 20,
    icon: 'Activity',
    tags: ['SMART', 'SSD', 'HDD', 'NVMe', 'Santé'],
    pkgNames: {
      debian: 'smartmontools nvme-cli',
      ubuntu: 'smartmontools nvme-cli',
      arch: 'smartmontools nvme-cli',
      alpine: 'smartmontools nvme-cli',
      fedora: 'smartmontools nvme-cli',
      opensuse: 'smartmontools nvme-cli',
      void: 'smartmontools nvme-cli',
    },
    appType: 'cli',
    systemImpact: 'low',
  },
  {
    id: 'chntpw',
    name: 'chntpw (Réinitialisation Mot de Passe Windows)',
    category: 'security',
    description: 'Utilitaire hors-ligne pour réinitialiser ou débloquer les mots de passe de comptes Windows SAM.',
    sizeMB: 10,
    icon: 'Key',
    tags: ['Rescue', 'Windows', 'Password', 'SAM'],
    pkgNames: {
      debian: 'chntpw',
      ubuntu: 'chntpw',
      arch: 'chntpw',
  ...
  {
    id: 'gamemode',
    name: 'Feral GameMode (Optimisation de Latence)',
    category: 'gaming',
    description: 'Démon d’optimisation dynamique des performances CPU/GPU et des priorités de processus pour les jeux.',
    sizeMB: 25,
    icon: 'Zap',
    tags: ['Gaming', 'Performance', 'LowLatency', 'Feral'],
    pkgNames: {
      debian: 'gamemode',
      ubuntu: 'gamemode',
      arch: 'gamemode',
  ...
  {
    id: 'mangohud',
    name: 'MangoHud (Overlay FPS & Vulkan)',
    category: 'gaming',
    description: 'Overlay HUD d’affichage des FPS, températures CPU/GPU, utilisation VRAM et temps de trame pour jeux Vulkan et OpenGL.',
    sizeMB: 30,
    icon: 'Monitor',
    tags: ['Gaming', 'Overlay', 'FPS', 'Vulkan', 'Benchmark'],
    pkgNames: {
      debian: 'mangohud',
      ubuntu: 'mangohud',
      arch: 'mangohud',
  ...
  // --- GESTION DE L’ÉNERGIE LAPTOP ---
  {
    id: 'tlp',
    name: 'TLP & Powertop (Gestion Énergie Batterie)',
    category: 'system',
    description: 'Optimisation automatique de l’autonomie de batterie pour ordinateurs portables sans configuration manuelle.',
    sizeMB: 35,
    icon: 'Zap',
    tags: ['Laptop', 'Batterie', 'TLP', 'Énergie', 'Autonomie'],
    pkgNames: {
      debian: 'tlp tlp-rdw powertop',
      ubuntu: 'tlp tlp-rdw powertop',
      arch: 'tlp powertop',
      alpine: 'tlp powertop',
      fedora: 'tlp tlp-rdw powertop',
      opensuse: 'tlp tlp-rdw powertop',
      void: 'tlp powertop',
    },
    appType: 'daemon',
    systemImpact: 'low',
  ...
  {
    id: 'wireguard_tools',
    name: 'WireGuard Tools (VPN Kernel Moderne)',
    category: 'security',
    description: 'Outils en ligne de commande et gestionnaire wg-quick pour tunnels VPN WireGuard chiffrés et rapides.',
    sizeMB: 15,
    icon: 'Network',
    tags: ['VPN', 'WireGuard', 'Sécurité', 'Réseau'],
    pkgNames: {
      ...
      void: 'wireguard-tools',
    },
    appType: 'cli',
    systemImpact: 'low',
  },

  // --- NOUVEAUX PACKAGES SYSTÈME & SHELL MODERNES (RUST / C) ---
  {
    id: 'fastfetch',
    name: 'Fastfetch (Sysinfo C Ultra-Rapide)',
    category: 'system',
    description: 'Afficheur d’informations système moderne en C, remplaçant Neofetch avec détection GPU/Vulkan et logo ASCII.',
    sizeMB: 12,
    icon: 'Info',
    tags: ['Sysinfo', 'Fastfetch', 'Terminal', 'C'],
    pkgNames: {
      debian: 'fastfetch pciutils usbutils',
      ubuntu: 'fastfetch pciutils usbutils',
      arch: 'fastfetch',
      alpine: 'fastfetch pciutils usbutils',
      fedora: 'fastfetch',
      opensuse: 'fastfetch',
      void: 'fastfetch',
    },
  ...
  {
    id: 'eza',
    name: 'Eza (Remplaçant Moderne de ls en Rust)',
    category: 'system',
    description: 'Alternative moderne et colorée à ls avec support Git, icônes, attributs étendus et arborescence.',
    sizeMB: 15,
    icon: 'Layers',
    tags: ['Rust', 'CLI', 'eza', 'ls', 'Utilitaires'],
    pkgNames: {
      debian: 'eza',
      ubuntu: 'eza',
      arch: 'eza',
  ...
  {
    id: 'bat_cat',
    name: 'Bat (Clone Moderne de Cat avec Syntaxe)',
    category: 'system',
    description: 'Afficheur de fichiers avec coloration syntaxique automatique pour 200+ langages et intégration Git.',
    sizeMB: 18,
    icon: 'FileText',
    tags: ['Rust', 'bat', 'cat', 'Syntax', 'Git'],
    pkgNames: {
      debian: 'bat',
      ubuntu: 'bat',
      arch: 'bat',
  ...
  {
    id: 'zoxide',
    name: 'Zoxide (Navigation cd Intelligente)',
    category: 'system',
    description: 'Commande cd ultra-rapide avec base de données d’apprentissage des répertoires les plus fréquents.',
    sizeMB: 10,
    icon: 'Folder',
    tags: ['Rust', 'zoxide', 'cd', 'Navigation', 'Productivité'],
    pkgNames: {
      debian: 'zoxide',
      ubuntu: 'zoxide',
      arch: 'zoxide',
  ...
  {
    id: 'starship',
    name: 'Starship (Prompt de Shell Cross-Distro)',
    category: 'system',
    description: 'Prompt minimaliste, ultra-rapide et personnalisable pour Bash, Zsh, Fish avec indicateurs Git et runtime.',
    sizeMB: 22,
    icon: 'Sparkles',
    tags: ['Starship', 'Prompt', 'Shell', 'Rust', 'Zsh', 'Bash'],
    pkgNames: {
      debian: 'starship',
      ubuntu: 'starship',
      arch: 'starship',
  ...
  {
    id: 'fzf',
    name: 'FZF (Fuzzy Finder Interactif pour Terminal)',
    category: 'system',
    description: 'Recherche floue interactive en ligne de commande pour fichiers, historique de commandes et processus.',
    sizeMB: 14,
    icon: 'Search',
    tags: ['FZF', 'FuzzyFinder', 'Terminal', 'Productivité'],
    pkgNames: {
      debian: 'fzf',
      ubuntu: 'fzf',
      arch: 'fzf',
  ...
  {
    id: 'btop_monitor',
    name: 'Btop++ (Moniteur de Ressources Graphique TUI)',
    category: 'system',
    description: 'Moniteur de processus et de ressources système moderne en C++ avec graphiques CPU/GPU, RAM, disques et réseau.',
    sizeMB: 16,
    icon: 'Activity',
    tags: ['Btop', 'Monitoring', 'CPU', 'RAM', 'Processus'],
    pkgNames: {
      debian: 'btop',
      ubuntu: 'btop',
      arch: 'btop',
  ...
  {
    id: 'zellij',
    name: 'Zellij (Multiplexeur de Terminal en Rust)',
    category: 'development',
    description: 'Espace de travail terminal complet avec onglets, panneaux redimensionnables, plugins WASM et mode flottant.',
    sizeMB: 28,
    icon: 'Terminal',
    tags: ['Zellij', 'Rust', 'Multiplexeur', 'Tmux', 'Terminal'],
    pkgNames: {
      debian: 'zellij',
      ubuntu: 'zellij',
      arch: 'zellij',
  ...
  {
    id: 'helix_editor',
    name: 'Helix Editor (Éditeur Modal Moderne Tree-Sitter)',
    category: 'development',
    description: 'Éditeur de code modal moderne en Rust avec LSP intégré, analyse syntaxique Tree-sitter et sélection multiple.',
    sizeMB: 32,
    icon: 'FileCode',
    tags: ['Helix', 'Rust', 'LSP', 'TreeSitter', 'Modal'],
    pkgNames: {
      debian: 'helix',
      ubuntu: 'helix',
      arch: 'helix',
  ...
  // --- CYBERSÉCURITÉ & AUDIT DE VULNÉRABILITÉS ---
  {
    id: 'trivy',
    name: 'Trivy (Scanner de Sécurité & CVEs)',
    category: 'security',
    description: 'Scanner complet de vulnérabilités pour conteneurs OCI, systèmes de fichiers, dépôts Git et configurations IaC.',
    sizeMB: 65,
    icon: 'Shield',
    tags: ['Trivy', 'CVE', 'Sécurité', 'Containers', 'IaC'],
    pkgNames: {
      debian: 'trivy',
      ubuntu: 'trivy',
      arch: 'trivy',
  ...
  {
    id: 'masscan',
    name: 'Masscan (Scanner de Ports TCP Haute Vitesse)',
    category: 'security',
    description: 'Scanner de ports TCP asynchrone capable de sonder de vastes plages IP à très haut débit.',
    sizeMB: 18,
    icon: 'Zap',
    tags: ['Masscan', 'Ports', 'Réseau', 'Audit', 'Pentest'],
    pkgNames: {
      debian: 'masscan',
      ubuntu: 'masscan',
      arch: 'masscan',
  ...
  {
    id: 'sqlmap',
    name: 'SQLMap (Audit & Injection SQL Automatique)',
    category: 'security',
    description: 'Outil libre d’audit automatisé pour détecter et exploiter les vulnérabilités d’injections SQL.',
    sizeMB: 25,
    icon: 'Database',
    tags: ['SQLMap', 'SQLi', 'Sécurité', 'Database', 'Pentest'],
    pkgNames: {
      debian: 'sqlmap',
      ubuntu: 'sqlmap',
      arch: 'sqlmap',
  ...
  {
    id: 'gobuster',
    name: 'Gobuster (Découverte Web & DNS en Go)',
    category: 'security',
    description: 'Outil haute performance écrit en Go pour forcer répertoires web, DNS, vhosts et buckets S3.',
    sizeMB: 20,
    icon: 'Globe',
    tags: ['Gobuster', 'Go', 'Web', 'DNS', 'Recon'],
    pkgNames: {
      debian: 'gobuster',
      ubuntu: 'gobuster',
      arch: 'gobuster',
  ...
  // --- MULTIMÉDIA, CRÉATION & AUDIO ---
  {
    id: 'ffmpeg_suite',
    name: 'FFmpeg & Codecs Vidéo/Audio',
    category: 'multimedia',
    description: 'Suite logicielle indispensable pour enregistrer, convertir et streamer des flux vidéo et audio multi-formats.',
    sizeMB: 110,
    icon: 'Film',
    tags: ['FFmpeg', 'Vidéo', 'Audio', 'Codecs', 'Transcodage'],
    pkgNames: {
      debian: 'ffmpeg',
      ubuntu: 'ffmpeg',
      arch: 'ffmpeg',
  ...
  {
    id: 'gimp_editor',
    name: 'GIMP (Éditeur d’Images & Retouche Photo)',
    category: 'multimedia',
    description: 'Programme libre de manipulation d’images bitmap, retouche photographique et composition graphique.',
    sizeMB: 180,
    icon: 'Image',
    tags: ['GIMP', 'Photo', 'Graphisme', 'Bitmap', 'Design'],
    pkgNames: {
      debian: 'gimp',
      ubuntu: 'gimp',
      arch: 'gimp',
  ...
  {
    id: 'inkscape_vector',
    name: 'Inkscape (Éditeur de Dessin Vectoriel SVG)',
    category: 'multimedia',
    description: 'Éditeur graphique professionnel pour illustrations vectorielles, logos, typographies et diagrammes SVG.',
    sizeMB: 195,
    icon: 'PenTool',
    tags: ['Inkscape', 'Vectoriel', 'SVG', 'Design', 'Illustration'],
    pkgNames: {
      debian: 'inkscape',
      ubuntu: 'inkscape',
      arch: 'inkscape',
  ...
  {
    id: 'audacity_audio',
    name: 'Audacity (Éditeur & Enregistreur Audio Multipiste)',
    category: 'audio',
    description: 'Station de montage audio numérique multipiste facile à utiliser pour podcasts, musique et effets sonores.',
    sizeMB: 85,
    icon: 'Music',
    tags: ['Audacity', 'Audio', 'Podcast', 'Enregistrement', 'Effets'],
    pkgNames: {
      debian: 'audacity',
      ubuntu: 'audacity',
      arch: 'audacity',
  ...
  {
    id: 'kdenlive_video',
    name: 'Kdenlive (Montage Vidéo Multi-Pistes Non-Linéaire)',
    category: 'multimedia',
    description: 'Éditeur de montage vidéo non-linéaire complet basé sur le framework MLT avec effets et transitions avancés.',
    sizeMB: 310,
    icon: 'Film',
    tags: ['Kdenlive', 'Vidéo', 'Montage', 'MLT', 'KDE', 'Effets'],
    pkgNames: {
      debian: 'kdenlive',
      ubuntu: 'kdenlive',
      arch: 'kdenlive',
  ...
  // --- CASQUES VR & RÉALITÉ VIRTUELLE (OPENXR & HARDWARE) ---
  {
    id: 'openxr_runtime',
    name: 'OpenXR Runtime & Monado VR (Khronos Certified)',
    category: 'gaming',
    description: 'Runtime OpenXR de référence open-source conforme Khronos pour casques VR (Valve Index, HTC Vive, Quest Link/WiVRn) avec service et interface de contrôle.',
    sizeMB: 180,
    icon: 'Glasses',
    tags: ['VR', 'OpenXR', 'Monado', 'Casque VR', 'Khronos'],
    pkgNames: {
      debian: 'monado-service monado-gui xr-hardware libopenxr1-monado',
      ubuntu: 'monado-service monado-gui xr-hardware libopenxr1-monado',
      arch: 'openxr steam-devices vulkan-tools',
      fedora: 'openxr monado steam-devices',
      opensuse: 'openxr steam-devices',
      alpine: 'openxr',
      void: 'openxr',
    },
    appType: 'daemon',
  ...
  {
    id: 'vr_headset_drivers',
    name: 'XR Hardware & VR Headset Udev Rules',
    category: 'gaming',
    description: 'Règles matérielles udev officielles pour la détection plug-and-play des casques VR (Valve Index, HTC Vive, Meta Quest, Bigscreen Beyond, WMR, PSVR2) sans permissions root.',
    sizeMB: 15,
    icon: 'HardDrive',
    tags: ['VR', 'Udev', 'Valve Index', 'HTC Vive', 'Meta Quest'],
    pkgNames: {
      debian: 'xr-hardware steam-devices',
      ubuntu: 'xr-hardware steam-devices',
      arch: 'steam-devices',
      fedora: 'steam-devices',
      opensuse: 'steam-devices',
      alpine: 'udev',
      void: 'udev',
    },
    appType: 'cli',
  ...
  {
    id: 'vr_wireless_streaming',
    name: 'VR Wireless Streaming (WiVRn / ALVR & Avahi mDNS)',
    category: 'gaming',
    description: 'Pile réseau et streaming temps réel pour casques autonomes (Meta Quest 2/3/Pro, Pico 4) avec découverte mDNS zéro-configuration et audio ultra-faible latence PipeWire.',
    sizeMB: 90,
    icon: 'Wifi',
    tags: ['VR', 'WiVRn', 'ALVR', 'Meta Quest', 'Pico 4', 'Sans-fil'],
    pkgNames: {
      debian: 'avahi-daemon libnss-mdns pipewire-audio-client-libraries',
      ubuntu: 'avahi-daemon libnss-mdns pipewire-audio-client-libraries',
      arch: 'avahi nss-mdns pipewire-pulse',
      fedora: 'avahi nss-mdns pipewire-pulseaudio',
      opensuse: 'avahi nss-mdns pipewire-pulseaudio',
      alpine: 'avahi pipewire-pulse',
      void: 'avahi pipewire-pulse',
    },
    appType: 'daemon',
    systemImpact: 'low',
  },

  // --- FABRICATION NUMÉRIQUE : IMPRESSION 3D & GRAVEUR LASER CNC ---
  {
    id: 'prusa_slicer',
    name: 'PrusaSlicer & Printrun (Trancheur 3D FDM / SLA)',
    category: 'productivity',
    description: 'Trancheur 3D de référence mondiale pour imprimantes 3D FDM et résine SLA (STL, OBJ, 3MF, STEP) avec générateur de G-code multi-marques et contrôle direct Pronterface.',
    sizeMB: 280,
    icon: 'Layers',
    tags: ['Impression 3D', 'Slicer', 'Prusa', 'G-code', 'FDM', 'SLA'],
    pkgNames: {
      debian: 'prusa-slicer printrun',
      ubuntu: 'prusa-slicer printrun',
      arch: 'prusa-slicer slicer-udev printrun',
      fedora: 'prusa-slicer printrun',
      opensuse: 'PrusaSlicer',
      alpine: 'prusa-slicer',
      void: 'prusa-slicer',
    },
    appType: 'gui',
  ...
  {
    id: 'freecad_openscad',
    name: 'FreeCAD & OpenSCAD (CAO 3D Paramétrique)',
    category: 'productivity',
    description: 'Suite de Conception Assistée par Ordinateur (CAO) 3D paramétrique pour la création de pièces mécaniques, modèles techniques et prototypes imprimables en 3D.',
    sizeMB: 420,
    icon: 'Box',
    tags: ['CAO', 'CAD', 'FreeCAD', 'OpenSCAD', '3D', 'Mécanique'],
    pkgNames: {
      debian: 'freecad openscad',
      ubuntu: 'freecad openscad',
      arch: 'freecad openscad',
      fedora: 'freecad openscad',
      opensuse: 'freecad openscad',
      alpine: 'openscad',
      void: 'freecad openscad',
    },
    appType: 'gui',
    systemImpact: 'heavy',
  },
  {
    id: 'laser_cnc_vector',
    name: 'Laser Engraver & CNC Vector Studio (Inkscape & LibreCAD)',
    category: 'productivity',
    description: 'Suite vectorielle 2D technique pour graveurs laser (GRBL, Ortur, Sculpfun, xTool) et fraiseuses CNC avec export SVG/DXF et extensions G-code.',
    sizeMB: 260,
    icon: 'Scissors',
    tags: ['Laser', 'Graveur Laser', 'CNC', 'Inkscape', 'LibreCAD', 'G-code'],
    pkgNames: {
      debian: 'inkscape librecad',
      ubuntu: 'inkscape librecad',
      arch: 'inkscape librecad',
      fedora: 'inkscape librecad',
      opensuse: 'inkscape librecad',
      alpine: 'inkscape librecad',
      void: 'inkscape librecad',
    },
    appType: 'gui',
    systemImpact: 'medium',
  },
  {
    id: 'hardware_serial_dialout',
    name: '3D Printer & Laser Serial Toolchain (CH340/CP210x/FTDI)',
    category: 'system',
    description: 'Outils de communication série USB (Minicom, SetSerial), règles udev non-root et suppression automatique des conflits brltty pour imprimantes 3D et graveurs laser.',
    sizeMB: 25,
    icon: 'Cpu',
    tags: ['USB Série', 'CH340', 'CP210x', 'FTDI', 'Brltty', 'Dialout'],
    pkgNames: {
      debian: 'setserial minicom',
      ubuntu: 'setserial minicom',
      arch: 'minicom',
      fedora: 'setserial minicom',
      opensuse: 'minicom',
      alpine: 'minicom',
      void: 'minicom',
    },
  ...
  // --- OUTILS D'ADMINISTRATION SYSTÈME & MAINTENANCE ---
  {
    id: 'gparted',
    name: 'GParted (Éditeur de Partitions Graphique)',
    category: 'system',
    description: 'Éditeur de partitions de disques graphique professionnel pour créer, redimensionner, déplacer et formater des partitions (ext4, btrfs, NTFS, FAT32).',
    sizeMB: 45,
    icon: 'HardDrive',
    tags: ['Partitions', 'Disque', 'GParted', 'GUI', 'Stockage'],
    pkgNames: {
      debian: 'gparted dosfstools mtools',
      ubuntu: 'gparted dosfstools mtools',
      arch: 'gparted dosfstools mtools',
      alpine: 'gparted dosfstools mtools',
      fedora: 'gparted dosfstools mtools',
      opensuse: 'gparted dosfstools mtools',
      void: 'gparted dosfstools mtools',
    },
    appType: 'gui',
    systemImpact: 'low',
  },
  {
    id: 'gnome_disk_utility',
    name: 'GNOME Disks / Disques (Gestionnaire de Stockage)',
    category: 'system',
    description: 'Gestionnaire de disques officiel avec surveillance de santé SMART, montage de volumes, benchmarks et restauration d’images ISO/IMG.',
    sizeMB: 35,
    icon: 'HardDrive',
    tags: ['Disques', 'SMART', 'ISO', 'Benchmark', 'GNOME'],
    pkgNames: {
      debian: 'gnome-disk-utility smartmontools',
      ubuntu: 'gnome-disk-utility smartmontools',
      arch: 'gnome-disk-utility smartmontools',
      alpine: 'gnome-disk-utility smartmontools',
      fedora: 'gnome-disk-utility smartmontools',
      opensuse: 'gnome-disk-utility smartmontools',
      void: 'gnome-disk-utility smartmontools',
    },
    appType: 'gui',
    systemImpact: 'low',
  },
  {
    id: 'timeshift',
    name: 'Timeshift (Instantanés & Restauration Système)',
    category: 'system',
    description: 'Outil de sauvegarde et de restauration du système d’exploitation façon Time Machine, supportant les instantanés Btrfs et rsync incrémental.',
    sizeMB: 50,
    icon: 'ShieldCheck',
    tags: ['Sauvegarde', 'Snapshots', 'Btrfs', 'Rsync', 'Restauration'],
    pkgNames: {
      debian: 'timeshift rsync cron',
      ubuntu: 'timeshift rsync cron',
      arch: 'timeshift rsync cronie',
      fedora: 'timeshift rsync crontabs',
      opensuse: 'timeshift rsync cron',
    },
    appType: 'gui',
    systemImpact: 'medium',
  },
  {
    id: 'synaptic',
    name: 'Synaptic Package Manager (Gestionnaire APT Graphique)',
    category: 'system',
    description: 'Gestionnaire graphique de paquets avancé basé sur APT permettant d’installer, mettre à jour, verrouiller et désinstaller les logiciels avec précision.',
    sizeMB: 30,
    icon: 'Package',
    tags: ['Paquets', 'APT', 'GUI', 'Synaptic', 'Admin'],
    pkgNames: {
      debian: 'synaptic',
      ubuntu: 'synaptic',
    },
  ...
  {
    id: 'inxi_hw',
    name: 'Inxi & Hwinfo (Diagnostic Matériel Avancé)',
    category: 'system',
    description: 'Outils complets de diagnostic et de détection matérielle système (CPU, GPU, mémoire, capteurs thermiques, disques, cartes réseau, pilotes).',
    sizeMB: 20,
    icon: 'Activity',
    tags: ['Diagnostic', 'Matériel', 'Inxi', 'CPU', 'GPU'],
    pkgNames: {
      debian: 'inxi hwinfo pciutils usbutils',
      ubuntu: 'inxi hwinfo pciutils usbutils',
      arch: 'inxi hwinfo pciutils usbutils',
      alpine: 'inxi pciutils usbutils',
      fedora: 'inxi hwinfo pciutils usbutils',
      opensuse: 'inxi hwinfo pciutils usbutils',
      void: 'inxi hwinfo pciutils usbutils',
    },
    appType: 'cli',
    systemImpact: 'low',
  },
  {
    id: 'gufw',
    name: 'Gufw Firewall (Interface Graphique Pare-feu UFW)',
    category: 'security',
    description: 'Interface graphique conviviale et visuelle pour administrer le pare-feu UFW, gérer les règles entrantes/sortantes et surveiller le trafic.',
    sizeMB: 25,
    icon: 'Shield',
    tags: ['Pare-feu', 'UFW', 'GUI', 'Sécurité', 'Réseau'],
    pkgNames: {
      debian: 'gufw ufw',
      ubuntu: 'gufw ufw',
      arch: 'gufw ufw',
