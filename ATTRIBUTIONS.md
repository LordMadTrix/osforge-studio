...
Ce projet intègre des ressources visuelles tierces sous licence libre.

## Logos de distributions & environnements de bureau

Les logos vectoriels affichés dans l'interface (`src/data/logos.ts`) proviennent du
set open-source [simple-icons](https://simple-icons.org) (licence MIT / CC0), utilisés
ici uniquement à des fins d'identification visuelle des marques correspondantes.
Chaque marque reste la propriété de son détenteur respectif.

## Captures d'écran réelles (`public/screenshots/`)

Toutes les captures ci-dessous proviennent de [Wikimedia Commons](https://commons.wikimedia.org),
redimensionnées et compressées en WebP pour ce projet. Licences originales conservées.

### Distributions

| Distribution | Auteur | Licence | Source |
|---|---|---|---|
| Debian | The Debian Project (capture : TOMats) | GPL-2.0-or-later / CC BY-SA 4.0 | [Fichier](https://commons.wikimedia.org/wiki/File:Debian_12_(Bookworm)_-_GNOME_desktop.png) |
| Ubuntu | Canonical Ltd. | GPL-2.0-or-later | [Fichier](https://commons.wikimedia.org/wiki/File:Ubuntu_24.04_LTS_default_desktop_-_English.png) |
| CachyOS | GKCMXLL | GPL-2.0-or-later | [Fichier](https://commons.wikimedia.org/wiki/File:CachyOS_250824.png) |
| Arch Linux | Arch Linux developers | GPL-2.0-or-later | [Fichier](https://commons.wikimedia.org/wiki/File:Arch_Linux_screenshot,_12.06.2024.png) |
| Alpine Linux | Codc | Domaine public | [Fichier](https://commons.wikimedia.org/wiki/File:Alpine_linux.JPG) |
| Kali Linux | Purpurreiher | GPL-2.0-or-later | [Fichier](https://commons.wikimedia.org/wiki/File:Kali_Linux_2021.2.png) |
| Fedora | The Fedora Project (capture : Kirbix12) | GPL-2.0-or-later | [Fichier](https://commons.wikimedia.org/wiki/File:Fedora_42_Workstation_Desktop_English.png) |
| NixOS | NixOS Foundation | GPL-2.0-or-later | [Fichier](https://commons.wikimedia.org/wiki/File:NixOS_21.11_GNOME_with_Files_and_default_theme_-_English.png) |
| Void Linux | The Void Linux Community | GPL-2.0-or-later | [Fichier](https://commons.wikimedia.org/wiki/File:Void_Linux_20210930_Xfce_Thunar_4.15.10_Adwaita_dark_theme_-_English.png) |
...
| Bureau | Auteur | Licence | Source |
|---|---|---|---|
| GNOME | The GNOME Project (capture : Paowee, CentOS Stream 10) | GPL-2.0-or-later | [Fichier](https://commons.wikimedia.org/wiki/File:CentOS_Stream_10_screenshot,_with_GNOME_47.png) |
| KDE Plasma | KDE developers (capture : VulcanSphere) | GPL-2.0+ / LGPL-2.1+ | [Fichier](https://commons.wikimedia.org/wiki/File:KDE_Plasma_6.3_desktop_screenshot.webp) |
| XFCE | Martin Wagner | GPL-2.0-or-later | [Fichier](https://commons.wikimedia.org/wiki/File:XFCE-4.12-Desktop-standard.png) |
| Cinnamon | Linux Mint Devs (capture : Funkruf) | GPL-2.0-or-later | [Fichier](https://commons.wikimedia.org/wiki/File:Linux_Mint_20_Cinnamon.png) |
| LXQt | LXQt developers | LGPL-2.1+ / GPL-2.0+ | [Fichier](https://commons.wikimedia.org/wiki/File:LXQt_2.0.0_Ambiance_screenshot.png) |
| Hyprland | Worthymelight | CC BY 4.0 | [Fichier](https://commons.wikimedia.org/wiki/File:Hyprland_screen.png) |
